...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //SETTING FRAGMENTS ON THE VIEW PAGER
    ...
    protected void onStart() {
        ...
        //CHECKING IF USER IS PRESENT, IF YES THEN CHECK IF USERNAME IS GIVER OR NOT
        //IF USERNAME IS EMPTY THEN CALL SETTINGS INTENT
    ...
    private void requestNewGroup() {
        ...
        groupNameField.setHint("E.g Developers");
